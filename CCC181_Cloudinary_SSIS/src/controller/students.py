...
def student_search():
    ...
    # Convert placeholder values to empty
    ...
    try:
        ...
        # Course only
        elif course_key_Code and not student_key_Level and not student_key_Gender:
            search_data = student_M.filter_search(course_key_Code, None, None)

        # Gender only
        elif student_key_Gender and not course_key_Code and not student_key_Level:
            search_data = student_M.filter_search(None, student_key_Gender, None)

        # Year only
        elif student_key_Level and not course_key_Code and not student_key_Gender:
            search_data = student_M.filter_search(None, None, student_key_Level)

        # Course + Year
        elif course_key_Code and student_key_Level and not student_key_Gender:
            search_data = student_M.search_combine(
                course_key_Code,
                student_key_Level,
                None
            )
        ...
        # Course + Gender
        elif course_key_Code and student_key_Gender and not student_key_Level:
            search_data = student_M.search_combine(
                course_key_Code,
                None,
                student_key_Gender
        ...
        # Year + Gender
        elif student_key_Level and student_key_Gender and not course_key_Code:
            search_data = student_M.search_combine(
                None,
                student_key_Level,
                student_key_Gender
        ...
        # Course + Year + Gender
        elif course_key_Code and student_key_Level and student_key_Gender:
            search_data = student_M.search_combine(
                course_key_Code,
                student_key_Level,
                student_key_Gender
            ...
            flash("Please Enter Valid Search!", "error")
